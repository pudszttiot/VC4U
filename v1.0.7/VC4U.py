...
class VideoCutterApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.input_button.setToolTip("Click to select the input video or audio file")
        ...
        self.output_button.setToolTip("Click to select the output video or audio file")
        ...
        self.cut_button.setText("Cut File")
        layout.addWidget(self.cut_button)
        self.cut_button.clicked.connect(self.cut_file)
        self.cut_button.setToolTip("Click to cut the video or audio file")
    ...
    def cut_file(self):
        if self.cut_thread and self.cut_thread.is_alive():
            QMessageBox.warning(
                self, "Warning", "A cutting operation is already in progress."
            )
            return
